            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="">
                                <img src="frontend/img/logo.gif" alt="">
                            </a>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                @foreach(Cart::content() as $cart)
                                                    <tr data-rowId="{{$cart->rowId}}">
                                                        <td class="si-pic">
                                                            <img style="height: 70px" src="frontend/img/products/{{$cart->options->images[0]->path}}" alt="">
                                                        </td>
                                                        <td class="si-text">
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="/shop/category/Women">Women’s Clothing</a></li>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="./admin/index">Admin Page</a></li>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="#"><img src="frontend/img/logo-ft.gif" alt=""></a>
                        </div>
                        <ul>
                            <li>Address: Yen Khe, Viet Hoa, Khoai Chau, Hung Yen</li>
                            <li>Phone: +84 916.710.295</li>
                            <li>Email: ncao515@gmail.com</li>
                        </ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
    ...
    <script src="frontend/js/owlcarousel2-filter.min.js"></script>
