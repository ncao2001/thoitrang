                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="admin/assets/images/avatars/{{Auth::user()->avatar ?? 'default-user.jpg'}}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="admin/assets/images/avatars/{{Auth::user()->avatar ?? 'default-user.jpg'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="./admin/index" class="{{(request()->segment(2) == 'index') ? 'mm-active' : ''}}" >
